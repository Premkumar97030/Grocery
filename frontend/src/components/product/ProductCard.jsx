  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="block relative pt-5 pb-3 overflow-hidden"
        style={{ transform: 'translateZ(25px)' }}
      >
        <div className="aspect-square rounded-2xl bg-gradient-to-b from-slate-50 to-slate-100/60 flex items-center justify-center overflow-hidden border border-slate-100/80 shadow-inner group-hover:shadow-[0_12px_24px_rgba(0,0,0,0.08)] transition-all duration-300">
          <img
            src={imageUrl}
            alt={product.name}
            loading="lazy"
